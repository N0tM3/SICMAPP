...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public ArrayList<Place> getPlaces(){
        ...
        mplaces.add(new Place(new LatLng(40.43197, -3.691550799999959),BitmapDescriptorFactory.fromResource(R.mipmap.marcador3),getResources().getString(R.string.titAgustin),getResources().getString(R.string.desAgustin),""));
