...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public ArrayList<Place> getPlaces(){
        ...
        mplaces.add(new Place(new LatLng(40.432827,-3.6911744999999883),BitmapDescriptorFactory.fromResource(R.mipmap.punterosicmadef),getResources().getString(R.string.titcompactadora),getResources().getString(R.string.d3),getResources().getString(R.string.imgcompactadora)));
